<html>
    ...
    <body class="login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <img src="<?php echo asset_url(); ?>/logo.png">
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input name="username" type="text" class="m-wrap placeholder-no-fix" autocomplete="off" placeholder="E-mail" data-parsley-errors-container="#error-container" data-parsley-error-message="Por favor, preencha seu nome de usuário / e-mail
" data-parsley-required value="">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-lock"></i>
                            <input name="password" class="m-wrap placeholder-no-fix" autocomplete="off" type="password" placeholder="Senha" data-parsley-errors-container="#error-container" data-parsley-error-message="Por favor, preencha sua senha" data-parsley-required value="">
